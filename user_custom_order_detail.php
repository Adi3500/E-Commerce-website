...
<body>
  ...
  <div class="container">
    ...
    if (isset($_GET['id'])) {
      ...
      $sql = "SELECT * FROM `custom_order` WHERE id = $product_id and username='$user'";
      ...
      if ($result !== false && $result->num_rows > 0) {
        ...
        echo "<img src='" . $row["design"] . "' alt='Product Image'>";
        echo "</div>";
        // Product details
        echo "<div class='product-details'>";
        echo "<div class='name'>Name: " . $row["type"] . "</div>";
        echo "<div>" . $row["fabric"] . "</div>";
