...
$user=$_SESSION['username'];
    $sql = "SELECT * FROM delivered_product where deliveryBoy_username='$user'" ; // Selecting all rows from delivered_product table
    $result = mysqli_query($connect, $sql);
    ...
    $sqll = "SELECT * FROM custom_delivered where deliveryBoy_username='$user'" ; // Selecting all rows from delivered_product table
...
$n=$n-1;
    echo "</tbody>
        <tfoot>
            <tr colspan='15'>
                <td ><h2>Total earning thorough Delivery :- </h2></td>
