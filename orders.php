...
<div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
  ...
  <h1 class="font-bold text-2xl py-6 px-16">Orders</h1>
  <?php
 ...
 $user=$_SESSION['user'];
  ...
  $sql = "SELECT * FROM `order` where username='$user' order By id DESC";
...
echo "<h2 class='px-6'>Order #" . $row["id"] . "</h2>";
echo "<ul class='products-list'>";
      
echo "<li class='product'>";
echo "<div class='product-card'>";
echo "<a href='order_detail.php?product_id=" . $row["id"] . "'>";
echo "<img src='" . $row["image"] . "' alt='Product Image' width='200' height='200'/>";
echo "</a>";
echo "<div class='product-details text-2xl py-6'>";
echo "<div class='font-bold'>" . $row["product"] . "</div><br>";
