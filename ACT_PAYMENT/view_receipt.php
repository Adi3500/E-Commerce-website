...
if ($filename) {
   ...
   // echo "<div class='px-4'><div class='text-2xl'> <div><br><a class='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800' href='$filename' download>Download Receipt</a></div>";
    // echo "<div class='px-4'><div class='text-2xl'> <div><br><a class='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800' href='user_home.php' download>Back To Home Page</a></div>";
