                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400  border-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 border border-gray-400 px-4 py-2 text-gray-800">Size/Material</th>
                            <th scope="col" class="px-6 py-3 border border-gray-400 px-4 py-2 text-gray-800">product_price</th>
                    ...
                    <tbody>
                        ...
                        $null="";
                        $sql = "SELECT * FROM `order` where sellername='$seller'and status=''";
                        $result = mysqli_query($connect, $sql);
