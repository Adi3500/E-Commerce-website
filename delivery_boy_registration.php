...
<body>
    <div class="form-container ">
        <div class="form-card">
            <h2 class="font-bold">Delivery Registration</h2>
                     ...
                     if (isset($_POST['btnInsert'])) {
                        ...
                        if ($_FILES['image']) {
                            ...
                            if (strtolower($image_ext) == "image/jpg" || strtolower($image_ext) == "image/jpeg" || strtolower($image_ext) == "image/png") {
                                ...
                                $query = "INSERT INTO `deliver_boy`(`name`, `delivery_username`, `email`, `password`, `mobile`, `account_no`, `gender`, `city`, `dob`, `image`) VALUES ('$name','$username','$email','$password','$mobile','$account','$gender','$city','$dob','$folder')";
         ...
         window.location.href='login.php'</script>";
                            ...
                            $query = "INSERT INTO `deliver_boy`(`name`, `delivery_username`, `email`, `password`, `mobile`, `account_no`, `gender`, `city`, `dob`, `image`) VALUES ('$name','$username','$email','$password','$mobile','$account','$gender','$city','$dob','$image')";
                            $result = mysqli_query($connect, $query);
