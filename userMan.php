...
<td >
<a href='userMan_delete.php?id=$row[id]'<button class='text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'  value='delete' id='delete_button' name='d'>Delete</button></a>

<a href='userMan_update.php?id=$row[id]'<button class='text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' value='delete' id='delete_button' name='d'>Update</button></a></td>
</tr>";
            $no = $no + 1;
        }
