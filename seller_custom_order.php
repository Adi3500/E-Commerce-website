                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400  border-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 border border-gray-400 px-4 py-2 text-gray-800">design</th>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM `custom_order` where sellername='$seller' and `status`=''";
                        $result = mysqli_query($connect, $sql);
...
<td>
<a href='seller_custom_order_update.php?id=$row[id]'<button class='text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' value='delete' id='delete_button' name='d'>Shipped</button></a></td>
</tr>";
                            $no = $no + 1;
                        }
